...
class NeuralNetwork():
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        # Definition of number of nodes in input, hidden and output layers.
        ...
        # Implementation of the sigmoid function to use as our activation function
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        delta_weights_i_h += self.lr * hidden_error_term * X.reshape(-1,1)

        # Weight step (hidden to output)
        delta_weights_h_o += self.lr * output_error_term * hidden_outputs.reshape(-1,1)
